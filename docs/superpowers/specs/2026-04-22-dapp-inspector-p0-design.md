...
> **状态: 已关闭(历史档)。** 本文档是 **2026-04-22 启动 P0 时的原始设计**,作为当时实现选择的依据保留,**不再随代码演进同步**。代码库已远超 P0 范围 —— Mock / Replay / Block 已落地、ABI 解码 / 风险高亮 / 链名解析等 P2 项已完成。
>
> **当前架构以仓库根 `CLAUDE.md` 为准**,P0 之后的新增子系统单独整理在 `docs/superpowers/specs/2026-05-05-post-p0-evolution.md`。
