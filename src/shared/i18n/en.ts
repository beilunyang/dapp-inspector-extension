export const en = {
  panel: {
    ...
    detail: {
      ...
      decoded: {
        ...
        typed: { domain: 'Domain', types: 'Types', message: 'Message' },
      },
      timing: {
        dapp: 'DApp dispatch',
  ...
  options: {
    ...
    capture: {
      ...
      autoFetchAbi: 'Auto-fetch ABI',
      autoFetchAbiDesc: 'Look up unknown contract ABIs from Sourcify and 4byte.sourcify.dev. Off = cache + built-ins only, no network requests.',
    ...
    advanced: {
      ...
      clearAbiCacheHint: 'Drops the locally cached Sourcify and 4byte ABI lookups. Next decoded view will refetch.',
