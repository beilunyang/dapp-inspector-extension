...
export const zh: I18nDict = {
  ...
  options: {
    ...
    capture: {
      ...
      storage: '存储占用',
      autoFetchAbi: '自动获取 ABI',
      autoFetchAbiDesc: '从 Sourcify 和 4byte.sourcify.dev 在线查询未知合约的 ABI。关闭后只用缓存和内置 ABI,不发起网络请求。',
      ignoredMethods: '忽略方法',
    ...
    advanced: {
      ...
      clearAbiCache: '清空 ABI 缓存',
      clearAbiCacheHint: '清除本地缓存的 Sourcify 与 4byte ABI 查询结果,下次打开解码视图会重新拉取。',
